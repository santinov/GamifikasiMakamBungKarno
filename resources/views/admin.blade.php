...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/kotablitar.png">
  <link rel="icon" type="image/png" href="../assets/img/kotablitar.png">
  <title>
    Admin Makam Bung Karno 
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" admin " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Selamat Datang Admin</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="bukukunjungan">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-app text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Buku Kunjungan</span>
          </a>
        </li>
        <li class="nav-item">
